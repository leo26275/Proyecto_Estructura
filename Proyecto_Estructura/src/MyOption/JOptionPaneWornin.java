...
public class JOptionPaneWornin extends javax.swing.JDialog {
    ...
    /**
     * Creates new form JOptionPaneWornin
     */
    public JOptionPaneWornin(java.awt.Frame parent, boolean modal, String titulo, String texto) {
        super(parent, modal);
        initComponents();
        this.setBackground(new Color (0, 0, 202, 0));
        jPanel1.setBackground(new Color (255, 255, 0, 225));
    ...
    private void initComponents() {
        ...
        tex.setText("Advertencia");

        tipo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        tipo.setText("Pueden aver campos  incorrectos ");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/advertencia (1).png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JOptionPaneWornin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JOptionPaneWornin dialog = new JOptionPaneWornin(new javax.swing.JFrame(), true, "", "");
