...
public class JOptionPaneInfo extends javax.swing.JDialog {
    ...
    /**
     * Creates new form JOptionPaneInfo
     */
    public JOptionPaneInfo(java.awt.Frame parent, boolean modal, String titulo, String texto) {
        super(parent, modal);
        initComponents();
        this.setBackground(new Color(0, 0, 202, 0));
        jPanel1.setBackground(new Color(0, 204, 204, 225));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JOptionPaneInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JOptionPaneInfo dialog = new JOptionPaneInfo(new javax.swing.JFrame(), true, "", "");
