...
public class ArbolBBPago<T> extends ArbolBinario {
    ...
    private NodoArbol insertar(T dato, NodoArbol r) {
        ...
        } else if (super.comparePago(dato, r) < 0) {
            NodoArbol izq;
    ...
    public NodoArbol buscar(String dato, NodoArbol r) {
        if (r == null) {
            return null;
        } else if (dato.compareToIgnoreCase(((Pago) r.getDato()).getFechapago()) == 0) {
            return r;
        } else {
            if (dato.compareToIgnoreCase(((Pago) r.getDato()).getFechapago()) < 0) {
                NodoArbol izq;
