...
public class ArbolBBUsuario<T> extends ArbolBinario {
    
    public ArbolBBUsuario() {
        super();
    }
    ...
    private NodoArbol insertar(T dato, NodoArbol r) {
        ...
        } else if (super.compareUsuario(dato, r) < 0) {
            NodoArbol izq;
    ...
    public NodoArbol buscar(String dato, NodoArbol r) {
        if (r == null) {
            return null;
        } else if (dato.compareToIgnoreCase(((Usuario) r.getDato()).getNombre()) == 0) {
            return r;
        } else {
            if (dato.compareToIgnoreCase(((Usuario) r.getDato()).getNombre()) < 0) {
                NodoArbol izq;
