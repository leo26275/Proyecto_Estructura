 ...
 * @author leo_g
 */
public class viewCliente1 extends javax.swing.JDialog {
     ...
     */
    public viewCliente1(java.awt.Frame parent, boolean modal, ArrayList<Venta> refere, String tipo1) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 114, 660, -1));
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 60, 120, 10));
    ...
    private void saveEMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveEMouseClicked
        ...
        llenarcombo();
        AddVenta a = new AddVenta(null, true, combo,null, refere1,"",tipo);
        this.dispose();
        a.setVisible(true);
        combo.clear();
        }
