 ...
 * @author leo_g
 */
public class viewProducto extends javax.swing.JDialog {
    ...
    ArrayList<CompraProducto> refere1;
     ...
     */
    public viewProducto(java.awt.Frame parent, boolean modal, ArrayList<CompraProducto> refere, String tipo1) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 60, 200, 20));
    ...
    private void saveEMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveEMouseClicked
        ...
        if (nombre.getText().isEmpty()) {
            ...
            llenarcombo();
            AddCompraProducto a = new AddCompraProducto(null, true, combo, refere1, tipo);
            this.dispose();
            a.setVisible(true);
            combo.clear();
        }
